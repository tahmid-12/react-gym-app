...
const TopNav = () => {
  ...
  return (
    <div className="max-w-[1520] mx-auto flex justify-between items-center p-4">
      ...
      {
        sideNav && <div className="bg-black/60 fixed w-full h-screen z-10 top-0 left-0" onClick={handleClick}>
      ...
      <div className={sideNav ? "fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-200" : "fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-200"}>
        <AiOutlineClose onClick={handleClick} size={25} className="absolute right-4 top-4 cursor-pointer"/>
        <h2 className="text-3xl p-4 font-bold">Yum <span className="text-orange-700">Eats</span></h2>
        <nav>
